...
# setup.sh — SecureClaw 一键引导脚本
# 处理 Node.js/npm 检测、依赖安装，然后交给 Node.js setup 模块
...
install_deps() {
  ...
  # 验证 native module (better-sqlite3)
...
log "=== SecureClaw Bootstrap started ==="
